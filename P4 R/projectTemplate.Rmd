...
```{r echo=TRUE, warning=FALSE, message=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', packages}
...
```{r echo=TRUE, warning=FALSE, warning=FALSE, Load_the_Data}
...
```{r echo=TRUE, warning=FALSE, warning=FALSE, cache=TRUE, cache.path='cache/', fig.path='figure/', Univar_BR}
...
#### Occupation
```{r echo=TRUE, warning=FALSE, warning=FALSE, cache=TRUE, cache.path='cache/', fig.path='figure/', Univar_Occup}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_ON}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Emp}
summary(pd$EmploymentStatus)
ggplot(aes(x = EmploymentStatus), data = subset(pd, !is.na(EmploymentStatus)))
...
#### TotalInquiries
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Inq}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_RCB}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Payments}
...
#### DebtToIncomeRatio
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_DTI}
...
#### IncomeRange 
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Inc}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Sti}
...
#### BorrowerState
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_ST}
...
### Loan
#### Term
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Term}
...
#### MonthlyLoanPayment
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_MPay}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_LoanAmt}
...
#### LoanStatus
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Stat}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Age}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Credit}
...
#### BankCardUtilization
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_BC}
...
#### ProsperScore
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_PS}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_PR}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/',  Bivar_corr}
...
```{r echo=TRUE, fig.path='figure/', warning=FALSE, cache=TRUE, cache.path='cache/'}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Loan}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Rate}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_DTI}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Income}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Occup}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Rating}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Payment}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Term}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Status}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Bivar_Bankcard}
summary(pd$BankcardUtilization)
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Bivar_Revol}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Bivar_DT}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_1}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_2}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_3}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_4}
...
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_5}
...
### Plot One
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Plot_One}
...
### Plot Two
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Plot_Two}
...
### Plot Three
```{r echo=TRUE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Plot_Three}
