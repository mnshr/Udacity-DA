...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_BR}
...
#### Occupation
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Occup}
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_ON}
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Emp}
summary(pd$EmploymentStatus)
ggplot(aes(x = EmploymentStatus), data = subset(pd, !is.na(EmploymentStatus))) + 
  geom_bar(fill = '#5760AB') 

ggplot(aes(x = EmploymentStatusDuration), data = subset(pd, !is.na(EmploymentStatusDuration))) + 
...
#### TotalInquiries
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Inq}
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_RCB}
summary(pd$RevolvingCreditBalance)
ggplot(aes(x = RevolvingCreditBalance), data = subset(pd, !is.na(RevolvingCreditBalance))) + 
  scale_y_log10()+
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Payments}
summary(pd$OnTimeProsperPayments)
ggplot(aes(x = OnTimeProsperPayments), data = subset(pd, !is.na(OnTimeProsperPayments))) + 
...
#### DebtToIncomeRatio
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_DTI}
summary(pd$DebtToIncomeRatio)
ggplot(aes(x = DebtToIncomeRatio), data = subset(pd, !is.na(DebtToIncomeRatio))) + 
...
#### IncomeRange 
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Inc}
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Sti}
summary(pd$StatedMonthlyIncome)
ggplot(data=subset(pd, !is.na(StatedMonthlyIncome)),aes(StatedMonthlyIncome)) +       
...
#### BorrowerState
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_ST}
...
### Loan
#### Term
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Term}
...
#### MonthlyLoanPayment
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_MPay}
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_LoanAmt}
...
#### LoanStatus
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Stat}
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Age}
ggplot(aes(LoanMonthsSinceOrigination), data = subset(pd, !is.na(LoanMonthsSinceOrigination))) + 
  geom_histogram(binwidth = 3, fill = '#5760AB') 
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Credit}
...
#### BankCardUtilization
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_BC}
...
#### ProsperScore
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_PS}
...
```{r echo=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_PR}
