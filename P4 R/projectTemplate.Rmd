...
```{r echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_2_1}
ggplot(aes(x=BorrowerRate, y=MeanCreditScore), 
       data=subset(pd, !is.na(BorrowerRate))) + 
...
```{r echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_4_}
...
```{r echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_6}
...
### Plot Two
```{r echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Plot_Two, fig.height=10, fig.width=10}
