...
```{r echo=FALSE, warning=FALSE, message=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', packages}
...
```{r echo=FALSE, warning=FALSE, warning=FALSE, Load_the_Data}
...
```{r echo=FALSE, warning=FALSE, warning=FALSE, cache=TRUE, cache.path='cache/', fig.path='figure/', Univar_BR}
...
#### Occupation
```{r echo=FALSE, warning=FALSE, warning=FALSE, cache=TRUE, cache.path='cache/', fig.path='figure/', Univar_Occup}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_ON}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Emp}
...
#### TotalInquiries
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Inq}
summary(pd$TotalInquiries)
ggplot(aes(x = TotalInquiries), data = subset(pd, !is.na(TotalInquiries))) + 
  scale_y_log10()+
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_RCB}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Payments}
summary(pd$OnTimeProsperPayments)
ggplot(aes(x = OnTimeProsperPayments), 
...
#### DebtToIncomeRatio
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_DTI}
...
ggplot(data=subset(pd, !is.na(DebtToIncomeRatio)),aes(x=DebtToIncomeRatio))+
  geom_histogram(binwidth=0.1, fill = '#5760AB')+
...
#### IncomeRange 
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Inc}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Sti}
...
#### BorrowerState
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_ST}
...
### Loan
#### Term
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Term}
...
#### MonthlyLoanPayment
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_MPay}
ggplot(data=subset(pd, !is.na(MonthlyLoanPayment)),aes(MonthlyLoanPayment))+
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_LoanAmt}
ggplot(aes(x = LoanOriginalAmount), data = subset(pd, !is.na(LoanOriginalAmount))) + 
...
#### LoanStatus
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Stat}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Age}
ggplot(aes(LoanMonthsSinceOrigination), 
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_Credit}
...
#### BankCardUtilization
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_BC}
ggplot(subset(pd, !is.na(BankcardUtilization)),aes(BankcardUtilization)) + 
...
#### ProsperScore
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_PS}
summary(pd$ProsperScore)
ggplot(aes(x = ProsperScore), data = subset(pd, !is.na(ProsperScore))) + 
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Univar_PR}
...
ggplot(aes(x = ProsperCreditRating), data = subset(pd, !is.na(ProsperCreditRating))) + 
  geom_bar(fill = '#78D20b') 
```
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/',  Bivar_corr}
...
```{r echo=FALSE, fig.path='figure/', warning=FALSE, cache=TRUE, cache.path='cache/'}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Loan}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Rate}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_DTI}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Income}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Occup}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Rating}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Payment}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Term}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path= 'cache/', fig.path='figure/', Bivar_Status}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Bivar_Bankcard}
summary(pd$BankcardUtilization)
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Bivar_Revol}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Bivar_DT}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_1}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_2}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_3}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_4}
...
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Multivar_5}
...
### Plot One
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Plot_One}
...
grid.arrange(p11, p12,top = "Credit Scores from Categorical Variable Perspective" )
...
### Plot Two
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Plot_Two, fig.height=6, fig.width=10}
secPalette <- c("#000000", "#0000FF", "#00FF00", "#FF0000", "#00FFFF", "#FFFF00", "#FF00FF", "#FFFFFF")
...
### Plot Three
```{r echo=FALSE, warning=FALSE, cache=TRUE, cache.path = 'cache/', fig.path='figure/', Plot_Three, fig.height=9, fig.width=11}
...
ggplot(data = subset(pd, !is.null(ProsperCreditRating)), 
  ...
  coord_cartesian(xlim = c(quantile(pd$LoanMonthsSinceOrigination, 0.025, na.rm=T), 
  ...
  ggtitle("Credit Scores by Loan Age for different Credit Ratings and Income Ranges") 
