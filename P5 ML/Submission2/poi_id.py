...
for rec in tmp_enron_data:
    ...
    # Creating stock_salary as a ratio of non-NaN total_stock_value and salary
    ...
    # Creating msg_from_poi as a non-NaN ratio of from_poi_to_this_person and 
    # to_messages variables (converted to float as to_messages is a string)
    ...
    # Creating msg_to_poi as a non-NaN ratio of from_this_person_to_poi and 
    # from_messages variables (converted to float as from_messages is stored
    # as a string)
    ...
    # Creating total_interact variable between an employee and a poi based
    # on ratio of total messages sent to and received from a poi and total
    # messages sent and received by an employee, all values being non-NaN
    # total_interact = (msg_from_poi + msg_to_poi) / (to_messages + from_messages)
...
data = featureFormat(tmp_enron_data, enron_features, sort_keys = True)
...
# Creating another set of features adding 1 newly derived feature 
# stock_salary which performed the best in SelectKBest among 
# the 4 new features I created
optimized_enron_features_plus_new = optimized_enron_features + ['stock_salary']
...
# With new feature stock_salary
data_new = featureFormat(tmp_enron_data, optimized_enron_features_plus_new ,
                     sort_keys = True)
labels_opti_new, features_opti_new = targetFeatureSplit(data_new)
features_opti_new = scaler.fit_transform(features_opti_new)
...
#classifierPerf(nb_clf, features_opti_new, labels_opti_new) 
