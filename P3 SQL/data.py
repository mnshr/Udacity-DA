# -*- coding: utf-8 -*-
"""
Created on Mon Feb 20 17:09:24 2017
...
from audit import test_audit, is_street_name, update_name, update_postcode, \
    expected, mapping, is_postcode, update_phone, is_phone
from tags import process_map_tags

OSM_PATH = "raleigh_north-carolina.osm"
#OSM_PATH = "raleigh-sample.osm"
...
def shape_element(element, node_attr_fields=NODE_FIELDS, way_attr_fields=WAY_FIELDS,
    ...
    if element.tag == 'node':
        ...
        # 2nd level
        for elem_2 in element.iter():
            if elem_2.tag == "tag":
                if PROBLEMCHARS.search(elem_2.attrib['k']) == None:
                    new_tag = add_tag(element, elem_2, default_tag_type)
        ...
        for elem_2 in element.iter():
            ...
            if elem_2.tag == "tag":
                ...
                temp['node_id'] = elem_2.attrib["ref"]
                temp['position'] = position
                position += 1
                way_nodes.append(temp)
        #print type(way_attribs), type(way_nodes), type(tags)
...
if __name__ == '__main__':
    keys = process_map_tags(OSM_PATH)
    pprint.pprint(keys)
